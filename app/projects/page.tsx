...
// 1. Define the Interface to solve "any" errors
interface Project {
    _id: string;
    title: string;
    description: string;
    ...
    useEffect(() => {
        const fetchAllData = async () => {
            try {
                ...
                // 3. Handle data structure safely
    ...
    if (loading) {
        return (
            <div className="bg-[#030303] h-screen flex items-center justify-center">
                <div className="text-[#C3F53C] font-mono animate-pulse tracking-[1em] uppercase text-xs">Initializing_Archive...</div>
            </div>
        );
    }
                ...
                <div className="max-w-[1200px] mx-auto">
                    ...
                    <header className="mb-48 relative">
                        ...
                        >
                            ...
                            <span className="text-[#C3F53C] font-mono text-[10px] uppercase tracking-[0.5em] font-black">Archive v2.0</span>
                        </motion.div>
                                ...
                                >
                                    ...
                                    <div className={`lg:col-span-7 relative ${index % 2 === 1 ? "lg:order-last" : ""}`}>
                                        ...
                                        >
                                            ...
                                            {project.launchLink && (
                                                <Link href={project.launchLink} target="_blank">
                                                    <div className="absolute top-8 right-8 bg-white/5 backdrop-blur-md border border-white/10 p-4 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0 cursor-pointer">
