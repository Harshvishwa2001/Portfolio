...
const ProjectPage = () => {
    const projects = [
        {
            title: "KartBuddy Ecosystem",
            desc: "A high-conversion landing page engineered for KartBuddy. Features modular architecture, 99+ Lighthouse scores, and fluid motion systems.",
        ...
        {
            title: "Connect Hub Pro",
            desc: "Professional networking architecture. Scalable MERN stack implementation featuring real-time professional connections and profile indexing.",
            devStack: ["Next JS", "Node JS", "MongoDB", "Tailwind"],
        ...
        },
        {
            ...
            desc: "Neural-driven visual generator. Integration with Google Gemini API for high-fidelity image synthesis based on natural language prompts.",
            devStack: ["MERN Stack", "Gemini AI", "Cloudinary"],
        ...
        },
        {
            ...
            desc: "A comprehensive travel platform enabling users to explore global destinations and manage online bookings seamlessly.",
        ...
        {
            title: "AI Text Architect",
            desc: "Intelligent content generation platform leveraging Gemini API to facilitate instant brainstorming and copywriting.",
        ...
        },
        {
            ...
            desc: "A sleek utility focused on state management and reactive UI. Designed for arithmetic operations with zero latency.",
                            ...
                            >
                                ...
                                <div className={`lg:col-span-7 relative ${index % 2 === 1 ? "lg:order-last" : ""}`}>
                                    ...
                                    <motion.div 
                                        ...
                                        className="relative rounded-[3rem] overflow-hidden border border-white/10 aspect-[16/10] bg-[#0a0a0a]"
                                    >
                                        <Image
                                            src={project.src}
                                            alt={project.title}
                                ...
                                {/* Content Container (lg:col-span-5) */}
                                <div className="lg:col-span-5 space-y-10">
                                    <div className="space-y-6">
                                        <div className="flex items-center gap-4">
                                            <span className="text-[#A186FF] font-mono text-sm font-black tracking-widest">0{index + 1}</span>
                                        ...
                                        <h3 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter leading-[0.9]">
                                            ...
                                            <span className="text-white/30 italic font-light">{project.title.split(' ').slice(1).join(' ')}</span>
                                        </h3>
                                    </div>
