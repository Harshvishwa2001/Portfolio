...
const Project = () => {
    ...
    if (loading) {
        return (
            <div className="bg-[#030303] py-60 text-center font-mono text-[#C3F53C] animate-pulse tracking-[0.5em] uppercase text-xs">
                Loading_Intel...
            </div>
        );
    }
            ...
            <div className='max-w-[1200px] mx-auto px-6'>
                ...
                <div className='space-y-40'>
                    {projects.slice(6,10).map((project, index) => {
                        // Safe Tag Parsing Logic
                        const tagArray = Array.isArray(project.tags) 
                            ? project.tags 
                            : (project.tags?.split(',') || []);
                            ...
                            >
                                ...
                                <div className='flex-1 space-y-6'>
                                    ...
                                    <div className='flex gap-6 pt-6 border-t border-white/5'>
                                        {project.codeLink && (
                                            <Link href={project.codeLink} target="_blank" className='flex items-center gap-2 group text-white/40 hover:text-white transition-all'>
                                        ...
                                        {project.launchLink && (
                                            <Link href={project.launchLink} target="_blank" className='flex items-center gap-2 group text-white/40 hover:text-white transition-all'>
                ...
                <div className="flex justify-center mt-24">
                    <Link href="/projects" className="group relative">
                        ...
                        <div className="relative px-12 py-4 bg-[#030303] border border-white/10 text-white rounded-full flex items-center gap-3 transition-all duration-300 group-hover:border-white/30">
